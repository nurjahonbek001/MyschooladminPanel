...
import com.nurjahonbek.myschooladminpanel.databinding.ScheduleItemBinding

class ScheduleAdapter
    (private var mTAbleList: List<ScheduleData>, private val c: Context) :
    RecyclerView.Adapter<ScheduleAdapter.TableViewHolder>() {

    inner class TableViewHolder( var binding: ScheduleItemBinding) :
    ...
    private fun moreDialog(holder: TableViewHolder, currentItem: ScheduleData) {
        ...
        AlertDialog.Builder(c)
            ...
            { d, p ->
                if (p == 0) {
                    ...
                    val i = Intent(c, ScheduleUp::class.java)
    ...
    private fun deleteClass(holder: TableViewHolder, currentItem: ScheduleData) {

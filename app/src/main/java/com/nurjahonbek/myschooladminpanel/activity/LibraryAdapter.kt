...
import com.nurjahonbek.myschooladminpanel.databinding.RewLibraryBinding
...
class LibraryAdapter(var mLibraryList: List<LibraryData>, private val c: Context) :
    ...
    inner class LibraryViewHolder( binding: RewLibraryBinding) :
    ...
    override fun onBindViewHolder(holder: LibraryViewHolder, position: Int) {
        ...
        holder.itemView.setOnClickListener {
            val i = Intent(c, LibraryUp::class.java)
            i.putExtra("id", id)
        ...
        holder.itemView.setOnClickListener {
            val i = Intent(c, ReadBook::class.java)
            i.putExtra("id", id)
            i.putExtra("title", title)
            c.startActivity(i)
        }

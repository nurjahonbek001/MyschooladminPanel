...
import com.nurjahonbek.myschooladminpanel.databinding.ActivityLibraryUpBinding

class LibraryUp : AppCompatActivity() {
    private val firebaseData = FirebaseDatabase.getInstance().getReference("BooksData")
    private lateinit var binding: ActivityLibraryUpBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityLibraryUpBinding.inflate(layoutInflater)
